...
from mlstclassifier_cd.tools import create_pie_chart
...
def modify_df(dataframe: pd.DataFrame) -> pd.DataFrame:
...
def main():
    ...
    # Create a pie-chart with the value count:
    create_pie_chart(df=df, output_dir=output_dir)
